...
def GetRank(appkey, tid, begin=None, end=None, days = None, page = None, pagesize=None, click_detail =None, order = None, AppSecret=None):
    """
获取排行信息
输入：
...
def GetBilibiliVideo(aid, appkey, AppSecret=None):
    overseas=False
    url_get_media = 'http://interface.bilibili.com/playurl?' if not overseas else 'http://interface.bilibili.com/v_cdn_play?'
    pid = '1'
    video = GetVideoInfo(aid,appkey,pid,AppSecret)
